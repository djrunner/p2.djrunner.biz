...
# Ideally, this should match the domain name
	define('APP_EMAIL', 'dbreidenbach@fas.harvard.edu'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'dbreidenbach@fas.harvard.edu'); 

# Default DB name for this app
	define('DB_NAME', "djrunner_p2_djrunner_biz"); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'this%is#LongA@Nothing!DrivethinktoAb*out');
	define('TOKEN_SALT', 'IGET$$MONEY$$M&NE*##MO@NE$LOT$OF%ON#EY$$');